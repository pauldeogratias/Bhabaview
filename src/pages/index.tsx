...
// // src/pages/index.tsx - Complete Improved Homepage with Modern Categories
// import React, { useState, useMemo, useEffect, Suspense } from 'react'
// // import { useRouter } from 'next/router'
// import Head from 'next/head'
// import { AlertCircle, X, ChevronRight, TrendingUp, Star, Users } from 'lucide-react'
...
// // Modern Category Section Component
...
//           }
//           50% { 
//             transform: translateY(-15px) rotateZ(0deg) scale(1.03);
//           }
//           75% { 
//             transform: translateY(-8px) rotateZ(-0.5deg) scale(1.02);
//           }
